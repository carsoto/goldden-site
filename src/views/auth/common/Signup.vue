  ...
  <form @submit.prevent="onSubmit" class="space-y-4">
    ...
    <label class="cursor-pointer flex items-start">
      ...
      <span
        ...
        :class="
          checkbox
            ? 'ring-2 ring-success-500 dark:ring-offset-slate-600 dark:ring-slate-900  dark:bg-slate-900 ring-offset-2 bg-green-goldden'
      ...
      <span class="text-slate-500 dark:text-slate-400 text-sm leading-6"
        >Acepta nuestras Condiciones generales y Política de privacidad</span
      >
    </label>
