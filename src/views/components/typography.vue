    ...
    <div class="lg:col-span-2 col-span-1">
      <Card title="Text Color">
        <div class="space-y-4">
          ...
          <p class="text-sm font-light text-success-500">
            Styling for common inline HTML5 elements.
          </p>
          <p class="text-sm font-light text-warning-500">
            This is warning-500 text You can archive this adding
            .text-warning-500 class
          </p>
          <p class="text-sm font-light text-danger-500">
            This is danger-500 text You can archive this adding .text-danger-500
            class
          </p>
        </div>
      </Card>
